...
class Block {
    ...
    prettify() {
        ...
        let blockStr = `<div><b>Block</b> #${this.hash}</div><img src="https://avatars.dicebear.com/api/micah/${this.hash}.svg" width="400" height="400"></div>`;

        blockStr += `<div><b>Timestamp:</b> ${this.timestamp}</div>`;

        blockStr += `<div><b>Previous Hash:</b> ${this.prevHash}</div></div><img src="https://avatars.dicebear.com/api/micah/${this.prevhash}.svg" width="400" height="400"></div>`;
